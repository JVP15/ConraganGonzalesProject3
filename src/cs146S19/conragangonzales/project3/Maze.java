...
public class Maze
{
	...
	/**
	 * Prints an ASCII formatted representation of a maze.
	 * '+' represents cell intersections and corners
	 * '|' and '-' represents cell walls 
	 */
	...
	private void createMaze()
	{
		...
		while(visitedCells < totalCells)
		{
			...
			{
				// Choose a neighboring cell at random, knock down its wall, and repeat for the modified cell
